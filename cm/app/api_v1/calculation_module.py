...
def calculation(output_directory, inputs_raster_selection, inputs_parameter_selection):
    ...
    if total_potential > 0:
        ...
        result["raster_layers"]=[{"name": "District heating areas - raster","path": output_raster1, "type": "custom",
                          "symbology": [
                              {"red":250,"green":159,"blue":181,"opacity":1,"value":symbol_vals_str[0],"label":" DH Area"},
                                    ]
                                    },
                          {"name": "Heat density map in potential DH areas - raster","path": output_raster2, "type": "heat", "layer": "heat_density_tot_curr"
                                    }
                                    ]
